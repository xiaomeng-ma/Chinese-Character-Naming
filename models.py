...
class Encoder(tf.keras.layers.Layer):
    ...
    def call(self, x, training, mask):
        ...
        # adding embedding and position encoding. # (batch_size, input_seq_len, d_model)
...
#     while True:
#         for seg_batch, char_batch in data_set:
#             yield ( [seg_batch , char_batch[:, :-1] ] , char_batch[:, 1:] )
#
...
class Transformer(tf.keras.Model):
    ...
    def call(self, inputs, training):
        ...
        enc_output = self.encoder((self.shared_emb(inp)), training, enc_padding_mask)  # (batch_size, inp_seq_len, d_model)
